...
- **AI 合规附录**：06-格式治理/06-S-05 §十一 AI 视觉合规执行守则.md v2.3.1
...
- 共享 `06-S-05` 品牌规范
- 共享 `06-S-06` Agent 协作与长期记忆手册（区分 `INTRE-vault` 与 `INTRE-website`，见 §3.6）
...
*本文档基于 2026-07-24 子项目全部实体倒推而成。INTRE 品牌规范权威定义在 `06-格式治理/06-S-05-INTRE-品牌视觉规范.md`（D1a 级），AI 协作者规范在 `06-格式治理/06-S-05 §十一 AI 视觉合规执行守则.md`。*
